#!/bin/bash
# Train image-content background inpainting (Flux-Kontext LoRA).
...
accelerate launch \
  ...
  --dataset_metadata_path /PATH/TO/DATASET/content/back_metadata.csv \
  ...
  --output_path "/PATH/TO/OUTPUT/content_back" \
  --lora_base_model "dit" \
  ...
  --save_steps 5000 \
  --lora_checkpoint "/PATH/TO/PRETRAINED_LORA/content_back.safetensors"
