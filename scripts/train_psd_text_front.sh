#!/bin/bash
# Train text-layer foreground extraction (Flux-Kontext LoRA).
...
accelerate launch \
  ...
  --dataset_metadata_path /PATH/TO/DATASET/text/front_metadata.csv \
  ...
  --output_path "/PATH/TO/OUTPUT/text_front" \
  --lora_base_model "dit" \
